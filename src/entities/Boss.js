const BOSS_VARIANTS = [
    { tint: null, starTints: [0x00ff44, 0x44ffaa, 0x00ee77], cometTints: [0xff4400, 0xff8800, 0xffcc00], speedMult: 1.0, healthBonus: 0 },
    { tint: 0xbb99ff, starTints: [0xcc44ff, 0xff88ff, 0xaa00ff], cometTints: [0x8800ff, 0xcc44ff, 0xff88ff], speedMult: 1.15, healthBonus: 1 },
    { tint: 0xff8888, starTints: [0xff2200, 0xff6644, 0xff9966], cometTints: [0xdd0000, 0xff4400, 0xff8800], speedMult: 1.2, healthBonus: 1 },
    { tint: 0x77ddff, starTints: [0x0088ff, 0x44bbff, 0x88ddff], cometTints: [0x0044cc, 0x0088ff, 0x44ccff], speedMult: 1.25, healthBonus: 2 },
    { tint: 0xffcc55, starTints: [0xffaa00, 0xffdd44, 0xffffff], cometTints: [0xff6600, 0xffaa00, 0xffee44], speedMult: 1.3, healthBonus: 2 },
    { tint: 0xff99cc, starTints: [0xff2288, 0xff66aa, 0xffaadd], cometTints: [0xcc0066, 0xff2288, 0xff88bb], speedMult: 1.35, healthBonus: 2 },
    { tint: 0x99ffcc, starTints: [0x00cc88, 0x44ffcc, 0xaaffee], cometTints: [0x00aa66, 0x00ffaa, 0x88ffdd], speedMult: 1.4, healthBonus: 3 },
    { tint: 0xffaa66, starTints: [0xff6600, 0xffaa44, 0xffdd88], cometTints: [0xff4400, 0xff8800, 0xffcc44], speedMult: 1.45, healthBonus: 3 },
    { tint: 0xaaaaff, starTints: [0x4444ff, 0x8888ff, 0xccccff], cometTints: [0x2200cc, 0x5544ff, 0xaaaaff], speedMult: 1.5, healthBonus: 3 },
    { tint: 0xffdd44, starTints: [0xffcc00, 0xffffff, 0xffee88], cometTints: [0xff8800, 0xffcc00, 0xffffff], speedMult: 1.55, healthBonus: 4 },
    { tint: 0xcc66ff, starTints: [0xaa00ff, 0xdd44ff, 0xff99ff], cometTints: [0x7700cc, 0xbb00ff, 0xee88ff], speedMult: 1.6, healthBonus: 4 },
    { tint: 0x66ffaa, starTints: [0x00ee66, 0x44ffaa, 0xccffee], cometTints: [0x00bb44, 0x44ff88, 0x99ffcc], speedMult: 1.65, healthBonus: 4 },
    { tint: 0xff6655, starTints: [0xff2200, 0xff8844, 0xffcc88], cometTints: [0xcc1100, 0xff4422, 0xff9966], speedMult: 1.75, healthBonus: 5 },
    { tint: 0xffffff, starTints: [0xffffff, 0xffeeaa, 0xffffcc], cometTints: [0xffcc00, 0xffffff, 0xffaa44], speedMult: 2.0, healthBonus: 6 },
];
